...
public class ReviewController {
    ...
    public ResponseEntity<ApiResponse<List<ReviewResponse>>> getByPost(@PathVariable Long postId) {
        List<ReviewResponse> reviews = reviewService.findByPostId(postId).stream()
